...
echo This creates BOM files for building the Sidecar
echo It requires sidecar.xml as an input. Make sure that it is up to date. Use the KiCAD schematic legacy BOM generator with the bom2grouped_csv.xsl plugin that's supplied with KiCAD.

set plugin_dir=C:\Users\shann\Dropbox\Python\BOM
set base_file=sidecar
